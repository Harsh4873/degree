...
export const APP_NAME = 'degree';

// Degree Canvas shares the existing pickledgerpro Firebase project with the
// other harsh.bet tools, but uses its own named app and degree_users
// collection so its auth session and data stay isolated on the same origin.
